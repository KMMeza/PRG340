...
public partial class _Default : System.Web.UI.Page
{
    ...
    // Will need to remove my Statements 
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            String database = "Palette";
            String myConnectionString = "Data Source=STUDENT; Initial Catalog=Palette; Integrated Security=true;";
            m_cnx = new SqlConnection(myConnectionString);
            try
            {
                m_cnx.Open();
            ...
            finally
            {
                if (m_cnx != null)
                {
                    ...
                    {
                        Session[ConnexionKey] = m_cnx; // retain connection and pass connection form page to page
                        ...
                        DataTable schema = m_cnx.GetSchema("Tables");
                        List<TableObject> TableNames = (List<TableObject>)Session[TableKey];
    ...
    protected void Available_Tables_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        //    SqlCommand cmd = new SqlCommand(str_query, m_cnx);
    ...
    {
        Server.Transfer("MngStudent.aspx", true);
    }
}